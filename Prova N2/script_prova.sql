...
CREATE TABLE IF NOT EXISTS academia.Treino (
    ...
    FOREIGN KEY (Aluno_ID)
        REFERENCES academia.Aluno (Aluno_ID),
...
CREATE TABLE IF NOT EXISTS academia.Aula (
    ...
    Modalidade_ID INT NOT NULL,
    Horario_ID INT NOT NULL,
    PRIMARY KEY (Instrutor_ID , Modalidade_ID , Horario_ID),
    FOREIGN KEY (Instrutor_ID)
        REFERENCES academia.Instrutor (Instrutor_ID),
    FOREIGN KEY (Horario_ID)
        REFERENCES academia.Horario (Horario_ID),
    FOREIGN KEY (Modalidade_ID)
        REFERENCES academia.Modalidade (Modalidade_ID)
...
INSERT INTO  academia.Instrutor (
  Instrutor_ID,
  Nome,
  Sobrenome,
  Endereco_ID,
