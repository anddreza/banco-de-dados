...
select * from musicas_has_artistas; 
...
(00000000003, 1, 1, '2019-10-21 21:29:00');
 ...
 select * from musicas_has_clientes;
...
ADD CONSTRAINT `fk_artistas_gravadoras1` 
...
ADD CONSTRAINT `fk_usuarios_planos1` 
...
--
ALTER TABLE `musicas`
ADD CONSTRAINT `fk_musicas_generos1` 
...
ADD CONSTRAINT `fk_musicas_has_artistas_artistas1` 
FOREIGN KEY (`artistas_id`) 
REFERENCES `artistas` (`id`) 
ON DELETE NO ACTION 
ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_musicas_has_artistas_musicas1` 
...
ADD CONSTRAINT `fk_musicas_has_usuarios_clientes1` 
FOREIGN KEY (`clientes_id`) 
REFERENCES `clientes` (`id`) 
ON DELETE NO ACTION 
ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_musicas_has_usuarios_musicas1` 
FOREIGN KEY (`musicas_id`) 
REFERENCES `musicas` (`id`) 
ON DELETE NO ACTION 
ON UPDATE NO ACTION;
...
select artistas.nome as artistas, musicas.nome as musicas, generos.descricao as generos
...
where musicas.generos_id <> 1 and 4